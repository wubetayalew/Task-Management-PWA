...
<body>
    <div class="login-page">
        ...
        <div class="form">
            <label class="cssFont_1">Add Task</label>
            <br>
            <br>
            <div>
              @if($errors->any())
          ...
          <form class="login-form" method="post" action="{{route('task.store')}}">
            ...
            <input  style="background-color: green; color: white;" type="submit" value="SAVE TASK">
